...
//   Future<void> loadSeats(String sessionId) async {
//     emit(const SeatListState(loading: true));

//     final entities = await getSeats(sessionId);

//     emit(SeatListState(seats: entities.map(SeatUiMapper.fromEntity).toList()));
//   }
// }
